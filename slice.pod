...
not given or equal "-") and divides its prepaired ASCII contents into possibly
...
The exclusive or relation between slice NAME1 and slice NAME2.
...
The difference of slice NAME1 minus slice NAME2.
...
processing this indicates an input error and F<slice> will respond with an
error message.
...
not needed under any fast runtime situation.  Usually F<slice> is used for
